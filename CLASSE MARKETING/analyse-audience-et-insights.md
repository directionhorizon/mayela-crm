...
**Fichier source** : `mayela-crm.html` (`loadSocialInsights()` l.1738, `renderInsights()` l.1641, `loadSocialTopClients()` l.1772), Edge Function `supabase/functions/social-insights/index.ts`.

---

## Analyse d'audience (« Analyser mon audience »)

**Fonction** : `loadSocialInsights(force)` (l.1738)
...
**Fonction** : `loadSocialTopClients()` (l.1772) ; limite pilotée par `topClientsLimit()` (l.1824, défaut 15).
